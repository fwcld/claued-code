...
- **질문 형식**: 질문은 정확히 **5개**만 한다. 인터뷰 시작 시 "총 5개 질문입니다"라고 먼저 안내한다.
  - 각 질문은 **객관식 4개 보기 + 주관식 1개**로 구성한다.
  - 객관식 보기 중 추천 선택지가 있으면 해당 항목 끝에 **(추천)** 표시를 붙인다.
  - 사용자는 객관식 번호를 고르거나 주관식으로 직접 답변할 수 있다.
